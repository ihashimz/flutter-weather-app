...
// in flutter_weather_app/test/features/weather/presentation/bloc/weather_bloc_test.dart.
...
import 'package:flutter_weather_app/core/errors/failures.dart' as _i6;
...
class MockGetCurrentWeather extends _i1.Mock implements _i4.GetCurrentWeather {
  ...
  _i5.Future<_i3.Either<_i6.Failure, _i7.Weather>> call(
          _i4.GetCurrentWeatherParams? params) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [params],
